...
DB_REMOTE_URL = "https://github.com/lang-uk/ukrainian-word-stress/raw/main/ukrainian_word_stress/data/stress.trie"
...
DEFAULT_LOCAL_PATH = os.path.join(os.path.dirname(__file__), "stress.trie")

def ensure_latest_db_file(local_path: str = DEFAULT_LOCAL_PATH, url: str = DB_REMOTE_URL, description: str = "Ukrainian word stress trie dictionary"):
    """Check if local trie DB file is up-to-date with remote, download if missing or outdated."""
    logger.info("Checking local trie stress dictionary file...")

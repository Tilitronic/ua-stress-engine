# Kaikki.org Data Types & Contribution Guide

## Overview

Kaikki.org provides structured, multilingual dictionary data extracted from Wiktionary and other sources. Each entry is a JSON object representing a word, its forms, senses, etymology, inflections, and more. This documentation describes the main data types, their fields, and how to contribute or extend the schema.

---

## Main Entry Structure

A typical Kaikki entry (one JSON object per word/part-of-speech) contains:
...
This documentation ensures contributors and users can work with Kaikki data confidently, with clear, type-safe structures and real-world examples.
